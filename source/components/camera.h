...
class Camera : public IComponent {
    ...
    public:
        ...
        void setupPerspective(float field_of_view_y, float aspect_ratio, float near, float far){
            this->type = xGame::CameraType::Perspective;
        ...
        void setupOrthographic(float orthographic_height, float aspect_ratio, float near, float far){
            this->type = xGame::CameraType::Orthographic;
        ...
        void setType(xGame::CameraType _type){
            if(this->type != _type){
        ...
        xGame::CameraType getType(){return type;}
